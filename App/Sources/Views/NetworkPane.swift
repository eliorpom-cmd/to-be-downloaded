...
struct NetworkPane: View {
    ...
    private var explanation: some View {
        VStack(spacing: 0) {
            ...
            Text("When Remote Control is active, you can control "
                 + "\(AppConfig.shortName) from any device on your local network, "
                 + "and download YouTube videos directly to your phone.")
